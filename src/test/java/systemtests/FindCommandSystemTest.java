...
public class FindCommandSystemTest extends CardCollectionSystemTest {
    ...
    public void find() {
         ...
         * -> 2 flashcards found
         */
        String command = "   " + FindCommand.COMMAND_WORD + " " + KEYWORD_MATCHING_HELLO + "   ";
        ...
        command = FindCommand.COMMAND_WORD + " Eat Newton";
        ...
        command = FindCommand.COMMAND_WORD + " Newton Eat";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple flashcards in card collection, 2 keywords with 1 repeat -> 2 flashcards found */
        command = FindCommand.COMMAND_WORD + " Newton Eat Newton";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
         ...
         * -> 2 flashcards found
         */
        command = FindCommand.COMMAND_WORD + " Newton Eat Cow";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        executeCommand(FindCommand.COMMAND_WORD + " Newton");
        ...
        assertFalse(getFlashcardListPanel().getHandleToSelectedCard().getFrontFace().equals(HELLO.getFrontFace().text));
        command = FindCommand.COMMAND_WORD + " Hello";
        ModelHelper.setFilteredList(expectedModel, HELLO);
        assertCommandSuccess(command, expectedModel);
